	...
	function __construct() {
		...
		//Initialize the settings
 		$default_settings = array(
 				...
 				'new_user' => false,
			    'email_suffix' => '',
			    'cas_version' => (defined('CAS_VERSION') ? CAS_VERSION : '1.0'),
			    'server_hostname' => (defined('CAS_SERVER') ? CAS_SERVER : 'yourschool.edu'),
			    'server_port' => (defined('CAS_SERVER_PORT') ? CAS_SERVER_PORT : '443'),
			    'server_path' => (defined('CAS_SERVER_PATH') ? CAS_SERVER_PATH : ''),
